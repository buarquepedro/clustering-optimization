...
def main():
	opt1 = PSO(dim=30, minf=-100, maxf=100, swarm_size=30, n_iter=100, w=0.8, lb_w=0.4, w_damp=0.99, c1=2.05, c2=2.05)
	opt1.optimize(ObjectiveFunction.sphere_function)

	opt2 = PSO(dim=30, minf=-30, maxf=30, swarm_size=30, n_iter=100, w=0.8, lb_w=0.4, w_damp=0.99, c1=2.05, c2=2.05)
	opt2.optimize(ObjectiveFunction.rosenbrock_function)

	opt3 = PSO(dim=30, minf=-5.12, maxf=5.12, swarm_size=30, n_iter=100, w=0.8, lb_w=0.4, w_damp=0.99, c1=2.05, c2=2.05)
	opt3.optimize(ObjectiveFunction.rastrigin_function)

	opt4 = PSO(dim=30, minf=-100, maxf=100, swarm_size=30, n_iter=100, w=0.8, lb_w=0.4, w_damp=0.99, c1=2.05, c2=2.05)
	opt4.optimize(ObjectiveFunction.schwefel_function)

	opt5 = PSO(dim=30, minf=-600, maxf=600, swarm_size=30, n_iter=100, w=0.8, lb_w=0.4, w_damp=0.99, c1=2.05, c2=2.05)
	opt5.optimize(ObjectiveFunction.griewank_function)

	opt6 = PSO(dim=30, minf=-32, maxf=32, swarm_size=30, n_iter=100, w=0.8, lb_w=0.4, w_damp=0.99, c1=2.05, c2=2.05)
